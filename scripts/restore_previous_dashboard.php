...
/**
 * Restore Previous Dashboard Design
 * Back to minimal header with text links (no CTA buttons)
 */

use Drupal\node\Entity\Node;

echo "↩️  RESTORING PREVIOUS DASHBOARD DESIGN\n";
echo "======================================\n\n";
...
echo "📄 Restoring: " . $node->getTitle() . "\n\n";

// Restore previous design with text links
$html = <<<'HTML'
...
echo "✅ Đã restore giao diện cũ!\n\n";

echo "🎨 Giao diện đã khôi phục:\n";
echo "   ✓ Text links với arrow: 'View dashboard →'\n";
echo "   ✓ Không có CTA buttons dạng outline\n";
echo "   ✓ Icon 40×40px (không phải 48×48px)\n";
echo "   ✓ Card layout cũ với shadow nhẹ hơn\n";
echo "   ✓ Login banner minimal (white card)\n";
echo "   ✓ Minimal header: 'Open CRM'\n\n";
