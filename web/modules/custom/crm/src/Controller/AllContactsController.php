...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .filter-input-wrap i{position:absolute;left:11px;top:50%;transform:translateY(-50%);width:16px;height:16px;color:#9ca3af;pointer-events:none;z-index:2}
  .filter-input{position:relative;width:100%;height:40px;padding:0 12px 0 36px;margin:0;border:1px solid #e5e7eb;border-radius:8px;font-size:14px;color:#1e293b;outline:none;transition:border-color .15s,box-shadow .15s;box-sizing:border-box;background:#fff;display:block}
